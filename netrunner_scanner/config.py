...
MOVED_SANITY_RESCAN_PX = 10
MOVED_SANITY_RESCAN_COOLDOWN_SECONDS = 0.60
...
MOVED_REIDENTIFY_ENABLED = True
MOVED_REIDENTIFY_MIN_PX = 3
...
STABLE_VISUAL_RECHECK_INTERVAL_SECONDS = 0.45
STABLE_VISUAL_RECHECK_DIFFERENT_THRESHOLD = 0.12
STABLE_VISUAL_RECHECK_SAME_THRESHOLD = 0.06
STABLE_VISUAL_RECHECK_MAX_PER_SCAN = 8
...
VISUAL_RECHECK_FORCE_PROCESS_THIS_SCAN = True
ALWAYS_RAW_VISUAL_DIFF_ENABLED = True
RAW_VISUAL_DIFF_SIZE = 16
RAW_VISUAL_DIFF_THRESHOLD = 0.075
RAW_VISUAL_DIFF_LOG_THRESHOLD = 0.045
RAW_VISUAL_DIFF_COOLDOWN_SECONDS = 0.10
RAW_VISUAL_DIFF_FORCE_PRIORITY = True
HOLD_KNOWN_ON_FORCED_UNKNOWN = True
HOLD_KNOWN_ON_FORCED_LOW_SCORE = True
ALLOW_CARDBACK_ON_FORCED_VISUAL_CHANGE = True
...
LAST_KNOWN_REACQUIRE_ENABLED = True
LAST_KNOWN_REACQUIRE_MISSING_SECONDS = 0.60
...
RAW_VISUAL_CHANGE_CONFIRMATIONS = 2
RAW_VISUAL_CHANGE_CONFIRM_WINDOW_SECONDS = 2.5
...
CONTROL_QUEUE_SECONDS_MIN = 4.0
CONTROL_QUEUE_SECONDS_MAX = 10.0
CONTROL_QUEUE_SECONDS_DEFAULT = 8.0
